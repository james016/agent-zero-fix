...
class OpenAIEmbeddings(BaseModel, Embeddings):
    ...
    tiktoken_api_url: Optional[str] = None
    ...
    def _tokenize(
        ...
        if not self.tiktoken_enabled:
            from langchain_openai.embeddings.auto_split import TextSplitter
            spliter = TextSplitter(model_name, api_key)

            for i, text in enumerate(texts):
                chunks = spliter.split_into_chunks(text, self.embedding_ctx_length)
